...
type MessageBlockchainGetDCDTTokenRequest struct {
	Message
	Address []byte
	TokenID []byte
	Nonce   uint64
...
func NewMessageBlockchainGetDCDTTokenRequest(address []byte, tokenID []byte, nonce uint64) *MessageBlockchainGetDCDTTokenRequest {
	message := &MessageBlockchainGetDCDTTokenRequest{}
	message.Kind = BlockchainGetDCDTTokenRequest
	message.Address = address
...
type MessageBlockchainGetDCDTTokenResponse struct {
	Message
	DCDTData *dcdt.DCDigitalToken
}

// NewMessageBlockchainGetDCDTTokenResponse creates a response message
func NewMessageBlockchainGetDCDTTokenResponse(dcdtData *dcdt.DCDigitalToken, err error) *MessageBlockchainGetDCDTTokenResponse {
	message := &MessageBlockchainGetDCDTTokenResponse{}
	message.Kind = BlockchainGetDCDTTokenResponse
	message.DCDTData = dcdtData
	message.SetError(err)
	return message
}
