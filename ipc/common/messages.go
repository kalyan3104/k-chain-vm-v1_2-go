...
const (
	...
	BlockchainGetDCDTTokenRequest
	BlockchainGetDCDTTokenResponse
...
func init() {
	...
	messageKindNameByID[BlockchainGetDCDTTokenRequest] = "BlockchainGetDCDTTokenRequest"
	messageKindNameByID[BlockchainGetDCDTTokenResponse] = "BlockchainGetDCDTTokenResponse"
